...
function submitVideoLog(tempFilePath, durationSec, recordedAtMs, sessionId, taskDate) {
  return new Promise(function (resolve, reject) {
    ...
    if (!tempFilePath) {
      reject(new Error("视频文件不存在，请重新录制"));
      return;
    }
    ...
    wx.uploadFile({
      url: C.API_BASE_URL.replace(/\/$/, "") + "/ema/video/submit-log",
...
function submitVideoSkipLog(recordedAtMs, sessionId, taskDate) {
...
module.exports = {
  submitVideoLog: submitVideoLog,
  submitVideoSkipLog: submitVideoSkipLog,
};
