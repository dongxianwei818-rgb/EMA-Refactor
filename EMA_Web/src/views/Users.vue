  ...
  <div class="page-users">
    <el-card shadow="never" class="page-card">
      ...
      >
        ...
        <el-table-column prop="research_id" label="研究编号" min-width="120">
        ...
        <el-table-column prop="study_status" label="状态" width="130">
          <template #default="{ row }">
            <el-tag
              :type="row.study_status === 'active' ? 'success' : 'danger'"
              size="small"
            >
              {{
                row.study_status === "active"
                  ? "激活"
                  : row.study_status === "exited"
                    ? "退出研究"
                    : row.study_status === "consent_revoked"
                      ? "撤回同意"
                      : "—"
              }}
              {{}}
